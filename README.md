...
See the file doc/results.png for an example of the result. Your pdf should shown a similar (but zoomable) picture showing the entire quicklisp system-list.
